...
export const mockProperties: Property[] = [
  {
    ...
    latitude: 41.3032,
    longitude: 69.2598,
    image_url: '/saltanat/assets/images/property_1_1.webp',
  ...
  },
  {
    ...
    latitude: 41.3045,
    longitude: 69.2601,
    image_url: '/saltanat/assets/images/property_2_2.webp',
  ...
  ...Array.from({ length: 38 }, (_, i) => {
    ...
    return {
      ...
      latitude,
      longitude,
      image_url: `/saltanat/assets/images/property_${(i % 2) + 1}_1.webp`, // Alternates between 1 and 2
